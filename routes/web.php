...
Route::prefix('admin')->middleware(['auth', CheckUserType::class])->group(function () {
  ...
  Route::get('import-categories', [CategoriesController::class, 'importView'])->name('import-data-show');

  Route::post('import-categories', [CategoriesController::class, 'importStore'])->name('import-data');
